...
gulp.task('docker-clean', shell.task([
	...
	'docker kill $(docker ps | grep "dev-peer0.org[123].example.com-e" | awk \'{print $1}\')',
	'docker rm $(docker ps -a | grep "dev-peer0.org[123].example.com-e" | awk \'{print $1}\')',

	// remove chaincode images so that they get rebuilt during test
	'docker rmi $(docker images | grep "^dev-peer0.org[123].example.com-e" | awk \'{print $3}\')',
...
// -TBD, pass test for Mac only
//gulp.task('test', ['clean-up', 'lint', 'pre-test', 'docker-ready', 'ca'], function() {
gulp.task('test', ['clean-up', 'pre-test', 'docker-ready', 'ca'], function() {
